...
-Resto o módulo (%): devuelve el resto de una división ENTERA (solo tipos enteros).
-Cociente o división entera(/): devuelve el cociente de la división (número entero).
...
int main(){
    ...
    cout << "Digite un numero entre 1 y 3999= "; 
    cin >> numero;
    //Ej 2152, 2000 - 100 - 50 - 2
